# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 11:15:10 2019
...
for num in [100,200,300,400,500,600,700,800,900]:
    G=nx.Graph()
...
#add_long_link(G)
    ...
    y=[nx.diameter(G)]
    t=0
    while(t<=G.number_of_nodes()/10):  #number of weak ties=10% of total nodes
        add_long_link(G)
        t=t+1
        x.append(t)
...
#plt.show()
    ...
    y1.append(np.average(m))  #average of all myopic searches 
